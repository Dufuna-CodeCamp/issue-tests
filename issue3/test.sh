...
echo -n "Enter HTML file name & location (e.g html-forms/contact.html) : "
read html_file
...
env FILE_PATH=$submission_directory/$folder_name/$html_file mocha $test_folder/issue3/html_form_task.js --reporter mochawesome --reporter-options reportDir=$customReportDir,reportFilename=$customReportFilename,quiet=true
