...
env FILE_PATH=$submission_directory/$folder_name/$form_file mocha $PWD/html_task.js --reporter mochawesome --reporter-options reportDir=$customReportDir,reportFilename=$customReportFilename,quiet=true
