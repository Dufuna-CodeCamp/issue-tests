...
echo -n "Enter form file name & location (e.g html-forms/contact.html) : "
read form_file
...
env FILE_PATH=$submission_directory/$folder_name/$form_file mocha $PWD/html_form_task.js --reporter mochawesome --reporter-options reportDir=$customReportDir,reportFilename=$customReportFilename,quiet=true
