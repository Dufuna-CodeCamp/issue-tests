...
echo -n "Enter HTML file name & location (e.g javascript/conditionals.js) : "
read html_file
...
env FILE_PATH=$submission_directory/$folder_name/$html_file mocha $test_folder/issue8/conditionals_task.js --reporter mochawesome --reporter-options reportDir=$customReportDir,reportFilename=$customReportFilename,quiet=true
