...
SET /P html_file="Enter HTML file name & location (e.g javascript/dom.js): "
...
env FILE_PATH=%path_to_folder:="%/%html_file:="% "%APPDATA:"=%\npm\mocha.cmd" "%test_folder:"=%\issue8\dom.js" --reporter mochawesome --reporter-options reportDir=%test_folder%,reportFilename=%customReportFilename%,quiet=true
