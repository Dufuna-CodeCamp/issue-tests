...
env FILE_PATH=$submission_directory/$folder_name/$html_file mocha $test_folder/issue2/html_task.js --reporter mochawesome --reporter-options reportDir=$customReportDir,reportFilename=$customReportFilename,quiet=true
